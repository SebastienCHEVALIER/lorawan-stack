...
func request_EndDeviceQRCodeGenerator_GenerateText_0(ctx context.Context, marshaler runtime.Marshaler, client EndDeviceQRCodeGeneratorClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GenerateEndDeviceQRCodeTextRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GenerateText(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_EndDeviceQRCodeGenerator_GenerateText_0(ctx context.Context, marshaler runtime.Marshaler, server EndDeviceQRCodeGeneratorServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GenerateEndDeviceQRCodeTextRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GenerateText(ctx, &protoReq)
	return msg, metadata, err

}

func request_EndDeviceQRCodeGenerator_GenerateImage_0(ctx context.Context, marshaler runtime.Marshaler, client EndDeviceQRCodeGeneratorClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GenerateEndDeviceQRCodeImageRequest
	var metadata runtime.ServerMetadata
...
func local_request_EndDeviceQRCodeGenerator_GenerateImage_0(ctx context.Context, marshaler runtime.Marshaler, server EndDeviceQRCodeGeneratorServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GenerateEndDeviceQRCodeImageRequest
	var metadata runtime.ServerMetadata
...
func RegisterEndDeviceQRCodeGeneratorHandlerServer(ctx context.Context, mux *runtime.ServeMux, server EndDeviceQRCodeGeneratorServer) error {
	...
	mux.Handle("POST", pattern_EndDeviceQRCodeGenerator_GenerateText_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_EndDeviceQRCodeGenerator_GenerateText_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_EndDeviceQRCodeGenerator_GenerateText_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_EndDeviceQRCodeGenerator_GenerateImage_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_EndDeviceQRCodeGenerator_GenerateImage_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_EndDeviceQRCodeGenerator_GenerateImage_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterEndDeviceQRCodeGeneratorHandlerClient(ctx context.Context, mux *runtime.ServeMux, client EndDeviceQRCodeGeneratorClient) error {
	...
	mux.Handle("POST", pattern_EndDeviceQRCodeGenerator_GenerateText_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_EndDeviceQRCodeGenerator_GenerateText_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_EndDeviceQRCodeGenerator_GenerateImage_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_EndDeviceQRCodeGenerator_GenerateImage_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_EndDeviceQRCodeGenerator_GetFormat_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"qrcodes", "end-devices", "formats", "format_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EndDeviceQRCodeGenerator_ListFormats_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"qrcodes", "end-devices", "formats"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EndDeviceQRCodeGenerator_GenerateText_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"qrcodes", "end-devices", "text"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EndDeviceQRCodeGenerator_GenerateImage_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"qrcodes", "end-devices", "image"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_EndDeviceQRCodeGenerator_GenerateText_0 = runtime.ForwardResponseMessage

	forward_EndDeviceQRCodeGenerator_GenerateImage_0 = runtime.ForwardResponseMessage
)
